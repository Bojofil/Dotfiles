...
myFont :: String
myFont = "xft:FiraGO Nerd Font Mono:regular:size=9:antialias=true:hinting=true"
...
jXPKeymap :: M.Map (KeyMask,KeySym) (XP ())
jXPKeymap = M.fromList $
...
myShowWNameTheme = def
    { swn_font              = "xft:FiraGO Nerd Font:Medium:size=60"
    , swn_fade              = 1.0
    , swn_bgcolor           = "#2E3440"
    , swn_color             = "#81A1C1"
    }
...
myWorkspaces = [" \xf269 ", " \xf120 ", " \xf07b ", " \xf15c ", " \xf11b ", " \xf025 ", " \xf0f2 ", " \xf16a "]
...
myClickableWorkspaces = clickable . (map xmobarEscape)
               -- $ [" 1 ", " 2 ", " 3 ", " 4 ", " 5 ", " 6 ", " 7 ", " 8 ", " 9 "]
               $ [" \xf269 ", " \xf120 ", " \xf114 ", " \xf0f6 ", " \xf11b ", " \xf025 ", " \xf0f2 ", " \xf16a "]
  where
...
myManageHook = composeAll
     ...
     , className =? "google-chrome" --> doShift  ( myWorkspaces !! 6 )
     , className =? "clonehero" --> doShift ( myWorkspaces !! 4 )
...
myKeys =
    ...
    -- Run Prompt
        -- , ("M-S-<Return>", shellPrompt jXPConfig) -- Xmonad Shell Prompt
        -- , ("M-S-<Return>", spawn "dmenu_run -i -p \"Run: \"") -- Dmenu
        , ("M-d", spawn "rofi -lines 12 -padding 18 -width 60 -location 0 -show drun -sidebar-mode -columns 3") -- Rofi
    ...
    --    ++ [("M-s " ++ k, S.promptSearch jXPConfig' f) | (k,f) <- searchList ]
    --    ++ [("M-S-s " ++ k, S.selectSearch f) | (k,f) <- searchList ]
    -- Appending some extra xprompts to keybindings list.
    -- Look at "xprompt settings" section this of config for values for "k".
  --      ++ [("M-p " ++ k, f jXPConfig') | (k,f) <- promptList ]
  --      ++ [("M-p " ++ k, f jXPConfig' g) | (k,f,g) <- promptList' ]
...
main = do
    ...
    xmproc0 <- spawnPipe "xmobar -x 0 /home/justin/.config/xmobar/xmobarrc0"
    xmproc1 <- spawnPipe "xmobar -x 1 /home/justin/.config/xmobar/xmobarrc2"
    xmproc2 <- spawnPipe "xmobar -x 2 /home/justin/.config/xmobar/xmobarrc1"
    ...
    xmonad $ ewmh def
        ...
        , logHook = workspaceHistoryHook <+> myLogHook <+> dynamicLogWithPP xmobarPP
                        ...
                        , ppHidden = xmobarColor "#81A1C1" ""  -- Hidden workspaces in xmobar
                        , ppHiddenNoWindows = xmobarColor "#81A1C1" ""        -- Hidden workspaces (no windows)
                        , ppTitle = xmobarColor "#81A1C1" "" . shorten 100     -- Title of active window in xmobar
                        , ppSep =  "<fc=#4C566A> <fn=2> </fn> </fc>"          -- Separators in xmobar
                        , ppUrgent = xmobarColor "#81A1C1" "" . wrap "!" "!"  -- Urgent workspace
